...
% Read an image
[filename, filepath] = uigetfile({'*.*'}, 'Select an image', 'C:\Users\admin\Documents\MATLAB\Images');
...
subplot(2,3,2);
imagesc(arah2); colorbar;
 title('Image scaled colors');
...
subplot(2,3,4);
imshow(edge_final); title('Output Image');
